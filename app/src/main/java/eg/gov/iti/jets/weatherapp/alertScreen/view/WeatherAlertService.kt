...
class WeatherAlertService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        mDialogView = LayoutInflater.from(this).inflate(R.layout.activity_dialog, null)
        ...
        val dismiss: Button = mDialogView.findViewById(R.id.button_dismiss)
        weatherDescTV = mDialogView.findViewById(R.id.textViewMessage)
